...
namespace elibraryclone
{
    public partial class usersignup1 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Member Already Exist with this ID, try some other ID');</script>");
            }
            else
            {
                signUpNewUser();
        ...
        void signUpNewUser()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO member_master_tbl (full_name,dob,contact_no," +
                    "email,state,city,pincode,full_address,member_id,password,account_status) values(@full_name,@dob,@contact_no," +
